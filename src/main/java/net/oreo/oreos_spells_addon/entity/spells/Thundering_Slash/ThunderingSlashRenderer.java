package net.oreo.oreos_spells_addon.entity.spells.Thundering_Slash;
...
public class ThunderingSlashRenderer extends EntityRenderer<ThunderingSlash> {
    private static final ResourceLocation[] TEXTURES = {
            oreos_spells_addon.id("textures/entity/thundering_slash/lightning_slash1.png"),
            oreos_spells_addon.id("textures/entity/thundering_slash/lightning_slash2.png"),
            oreos_spells_addon.id("textures/entity/thundering_slash/lightning_slash3.png"),
            oreos_spells_addon.id("textures/entity/thundering_slash/lightning_slash4.png")
    };

    public ThunderingSlashRenderer(Context context) {
        super(context);
    }

    @Override
    public void render(ThunderingSlash entity, float yaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int light) {
        poseStack.pushPose();
    ...
    private void drawSlash(Pose pose, ThunderingSlash entity, MultiBufferSource bufferSource, float width, boolean mirrored) {
    ...
    @Override
    public ResourceLocation getTextureLocation(ThunderingSlash entity) {
