package net.oreo.oreos_spells_addon.entity.spells.BloodyCleave;
...
public class BloodyCleaveRenderer extends EntityRenderer<BloodyCleave> {
    private static final ResourceLocation[] TEXTURES = {
            oreos_spells_addon.id("textures/entity/bloody_cleave/bloody_cleave_1.png"),
            oreos_spells_addon.id("textures/entity/bloody_cleave/bloody_cleave_2.png"),
            oreos_spells_addon.id("textures/entity/bloody_cleave/bloody_cleave_3.png"),
            oreos_spells_addon.id("textures/entity/bloody_cleave/bloody_cleave_4.png")
    };

    public BloodyCleaveRenderer(Context context) {
        super(context);
    }

    @Override
    public void render(BloodyCleave entity, float yaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int light) {
        poseStack.pushPose();
    ...
    private void drawSlash(Pose pose, BloodyCleave entity, MultiBufferSource bufferSource, float width, boolean mirrored) {
    ...
    @Override
    public ResourceLocation getTextureLocation(BloodyCleave entity) {
