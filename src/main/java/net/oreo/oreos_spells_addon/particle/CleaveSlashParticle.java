...
public class CleaveSlashParticle extends TextureSheetParticle {
    private final SpriteSet sprites;
    private int frameAge;

    protected CleaveSlashParticle(ClientLevel level, double x, double y, double z,
    ...
    public void tick() {
        ...
        this.quadSize = 0.25f * pulseScale;
